...
class Config:
    ...
    # Modified: Slope-based prediction instead of returns
    SLOPE_PREDICTION_WINDOW = 15  # seconds ahead to predict slope
    SLOPE_THRESHOLD_POSITIVE = 0.0001  # threshold for positive slope classification
    SLOPE_THRESHOLD_NEGATIVE = -0.0001  # threshold for negative slope classification
    
    PREDICTION_HORIZON = 10  # kept for backward compatibility
    MIN_VALID_FEATURES = 100
    STABLE_START_TIME = "00:31:55"
    
    # Feature statistics computation settings
    FEATURE_STATS_SAMPLE_RATE = 0.05  # Use 5% sample for faster computation
    FEATURE_STATS_MAX_DAYS = 50  # Limit number of days for stats computation
    FEATURE_STATS_PARALLEL = True  # Enable parallel computation
    ...
    def print_config(cls):
        ...
        print(f"Slope Prediction Window: {cls.SLOPE_PREDICTION_WINDOW} seconds")
        print(f"Total Features: {cls.get_num_features()}")
        print(f"Feature Stats Sample Rate: {cls.FEATURE_STATS_SAMPLE_RATE*100}%")
        print("="*60)